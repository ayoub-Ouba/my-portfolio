...
export default function  Project (props){
    ...
    return(
<div className="max-w-[25rem] bg-[#ffffffe9] border  rounded-lg shadow-xl " data-aos="fade-up">
    <div className="  shadow-md  w-[95%] mx-auto my-2 h-[180px]">
        <img className=" h-[100%] w-[100%] " src={props.project.image} alt="" />
    </div>
    <div className="p-5">
       
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-black ">{props.project.titre}</h5>
